  ...
  if(typeof(Worker) != 'undefined') {
    ...
    Array.from(files).forEach(function(file){
      ...
      authSession.then(token => {
        //const pathname = (pydio._dataModel._currentRep === "/") ? (Curate.workspaces.getOpenWorkspace() + "/" + file.name) : (Curate.workspaces.getOpenWorkspace() + pydio._dataModel._currentRep + "/" + file.name);
        ...
        getAvailableFilename(token, pathname, headers)
          .then(availableFilename => {
            //const relpath = (pydio._dataModel._currentRep === "/") ? (availableFilename) : (Curate.workspaces.getOpenWorkspace() + pydio._dataModel._currentRep + availableFilename.replace(Curate.workspaces.getOpenWorkspace(),""));
