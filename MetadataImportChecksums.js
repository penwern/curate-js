    ...
    searchNodes
        ...
        .then(rjs => {
            ...
            comparison.matches.forEach(match => {
              ...
              const foundElement = uploadedElements.find(element => element.textContent.includes(match.Name)).querySelector("div > div > div:nth-child(1) > div:nth-child(2) > div:first-child");
