    ...
    searchNodes
        ...
        .then(rjs => {
            ...
            comparison.matches.forEach(match => {
              ...
              const foundElement = uploadedElements.find(element => element.textContent.includes(match.Name)).querySelectorAll('div').find(div => div.textContent.includes(filename));
